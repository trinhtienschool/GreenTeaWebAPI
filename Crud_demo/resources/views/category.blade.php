...
{{--            <h5 class="my-4 dark-grey-text font-weight-bold">Responsive table</h5>--}}
            ...
            <div class="card card-cascade narrower z-depth-1">
                ...
                <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="" class="white-text mx-3">Bảng danh mục</a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="form_send_input" method="post" action="{{route('cate.store')}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="md-form">
...
{{--                                            <label for="avatar_input">Avatar</label>--}}
                                        ...
                                        <div class="md-form">
                                            <input type="text" id="price_input" name="slug" value="{{old('slug')}}" class="form-control">
                                            <label for="price_input">Slug</label>
                                        </div>
...
{{--                                    <button type="submit" class="btn btn-primary">Lưu thay đổi</button>--}}
                    ...
                    @if(Session::has('cate_edit'))
                        @php
                        $cate_edit=Session::get('cate_edit')
                        @endphp
                    <div class="modal fade" id="editExpand" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="form_send_edit" method="post" action="{{route('cate.update',$cate_edit->id)}}" enctype="multipart/form-data">
                                        {!! method_field('patch') !!}
                                        @csrf
                                        <div class="md-form">
                                            <input type="text" id="edit_name" name="name" value="{{old('name',$cate_edit->name)}}" class="form-control">
                                            <label for="name_input">Tên</label>
                                        </div>
                                        <div class="md-form">
                                            <img style="height: 75px;width: 75px" src="{{old('avatar',asset('images')."/".$cate_edit->avatar)}}" alt="">
                                        ...
                                        <div class="md-form">
                                            <input type="text" id="edit_slug" name="slug" value="{{old('slug',$cate_edit->slug)}}" class="form-control">
...
<script>
    ...
    function view(){
        if(!isChecked()) return;
        $.ajax({
            type:'Get',url:"{{route('cate.show','')}}/"+id_checked
        }).done(function(data) {
            // alert(data)
    ...
    function del(){
        ...
        $.ajax({
            ...
            type:'Delete',url:"{{route('cate.destroy','')}}/"+id_checked
        }).done(function(data) {
            // alert(data)
    ...
    function edit(){
        if(!isChecked()) return;
        window.location.href = 'cate/'+id_checked+"/edit";
    }
